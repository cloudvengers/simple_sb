pipeline {
    ...
    environment {
        GITNAME = 'cloudvengers'            
        GITEMAIL = 'cloudvengers@gmail.com' 
        GITWEBADD = 'https://github.com/cloudvengers/simple_sb.git'
        GITSSHADD = 'git@github.com:cloudvengers/sb_code.git'
        GITCREDENTIAL = 'git_cre'
        
        DOCKERHUB = 'cloudvengers/spring'
